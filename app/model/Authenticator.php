...
class Authenticator extends Nette\Object implements Security\IAuthenticator
{
	...
	public function authenticate(array $credentials)
	{
		...
		if (!$row) {
			throw new Security\AuthenticationException('Neplatné uživatelské jméno.', self::IDENTITY_NOT_FOUND);
		}
                
		if ($row->active == false) {
                        throw new Security\AuthenticationException('Účet není aktivní.', self::NOT_APPROVED);
                }
